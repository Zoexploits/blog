    ...
    <div class="w-full max-w-3xl bg-white p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ route('posts.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" class="mt-2 w-full px-4 py-3 text-lg border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter the title" required>
            </div>

            <!-- Post Content Textarea -->
            <div>
                <label for="content" class="block text-lg font-semibold text-gray-700">Post Content</label>
                <textarea id="content" name="content" rows="12" class="mt-2 w-full px-4 py-3 text-lg border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Write your post here..." required></textarea>
            </div>
            
            <div>
                <label for="image" class="block text-lg font-semibold text-gray-700">Image:</label>
                <input type="file" name="image" id="image" accept="image/*" class="mt-2 w-full px-4 py-3 text-lg border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
