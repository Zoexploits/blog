...
<div class="container mx-auto p-6 bg-gray-50">
    <div class="grid grid-cols-1 gap-6 max-w-lg mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <div class="text-center">
            <button type="submit" class="px-6 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">Update User Record</button>
        </div>
    </div>
</div>
